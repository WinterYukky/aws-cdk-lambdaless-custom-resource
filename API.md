...
### LambdalessProvider <a name="LambdalessProvider" id="aws-cdk-lambdaless-custom-resource.LambdalessProvider"></a>

#### Initializers <a name="Initializers" id="aws-cdk-lambdaless-custom-resource.LambdalessProvider.Initializer"></a>

```typescript
import { LambdalessProvider } from 'aws-cdk-lambdaless-custom-resource'

new LambdalessProvider(scope: Construct, id: string, _props: LambdalessProviderProps)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#aws-cdk-lambdaless-custom-resource.LambdalessProvider.Initializer.parameter.scope">scope</a></code> | <code>constructs.Construct</code> | *No description.* |
| <code><a href="#aws-cdk-lambdaless-custom-resource.LambdalessProvider.Initializer.parameter.id">id</a></code> | <code>string</code> | *No description.* |
| <code><a href="#aws-cdk-lambdaless-custom-resource.LambdalessProvider.Initializer.parameter._props">_props</a></code> | <code><a href="#aws-cdk-lambdaless-custom-resource.LambdalessProviderProps">LambdalessProviderProps</a></code> | *No description.* |

---

##### `scope`<sup>Required</sup> <a name="scope" id="aws-cdk-lambdaless-custom-resource.LambdalessProvider.Initializer.parameter.scope"></a>

- *Type:* constructs.Construct

---

##### `id`<sup>Required</sup> <a name="id" id="aws-cdk-lambdaless-custom-resource.LambdalessProvider.Initializer.parameter.id"></a>

- *Type:* string

---

##### `_props`<sup>Required</sup> <a name="_props" id="aws-cdk-lambdaless-custom-resource.LambdalessProvider.Initializer.parameter._props"></a>

- *Type:* <a href="#aws-cdk-lambdaless-custom-resource.LambdalessProviderProps">LambdalessProviderProps</a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#aws-cdk-lambdaless-custom-resource.LambdalessProvider.toString">toString</a></code> | Returns a string representation of this construct. |
| <code><a href="#aws-cdk-lambdaless-custom-resource.LambdalessProvider.with">with</a></code> | Applies one or more mixins to this construct. |

---

##### `toString` <a name="toString" id="aws-cdk-lambdaless-custom-resource.LambdalessProvider.toString"></a>
...
##### `with` <a name="with" id="aws-cdk-lambdaless-custom-resource.LambdalessProvider.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="aws-cdk-lambdaless-custom-resource.LambdalessProvider.with.parameter.mixins"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#aws-cdk-lambdaless-custom-resource.LambdalessProvider.isConstruct">isConstruct</a></code> | Checks if `x` is a construct. |

---

##### `isConstruct` <a name="isConstruct" id="aws-cdk-lambdaless-custom-resource.LambdalessProvider.isConstruct"></a>

```typescript
import { LambdalessProvider } from 'aws-cdk-lambdaless-custom-resource'

LambdalessProvider.isConstruct(x: any)
```
...
###### `x`<sup>Required</sup> <a name="x" id="aws-cdk-lambdaless-custom-resource.LambdalessProvider.isConstruct.parameter.x"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#aws-cdk-lambdaless-custom-resource.LambdalessProvider.property.node">node</a></code> | <code>constructs.Node</code> | The tree node. |
| <code><a href="#aws-cdk-lambdaless-custom-resource.LambdalessProvider.property.serviceToken">serviceToken</a></code> | <code>string</code> | *No description.* |
| <code><a href="#aws-cdk-lambdaless-custom-resource.LambdalessProvider.property.stateMachine">stateMachine</a></code> | <code>aws-cdk-lib.aws_stepfunctions.StateMachine</code> | *No description.* |

---

##### `node`<sup>Required</sup> <a name="node" id="aws-cdk-lambdaless-custom-resource.LambdalessProvider.property.node"></a>
...
##### `serviceToken`<sup>Required</sup> <a name="serviceToken" id="aws-cdk-lambdaless-custom-resource.LambdalessProvider.property.serviceToken"></a>
...
##### `stateMachine`<sup>Required</sup> <a name="stateMachine" id="aws-cdk-lambdaless-custom-resource.LambdalessProvider.property.stateMachine"></a>
...
### OriginalStepFunctionsFlow <a name="OriginalStepFunctionsFlow" id="aws-cdk-lambdaless-custom-resource.OriginalStepFunctionsFlow"></a>

#### Initializers <a name="Initializers" id="aws-cdk-lambdaless-custom-resource.OriginalStepFunctionsFlow.Initializer"></a>

```typescript
import { OriginalStepFunctionsFlow } from 'aws-cdk-lambdaless-custom-resource'

new OriginalStepFunctionsFlow(scope: Construct, id: string, props: OriginalStepFunctionsFlowProps)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#aws-cdk-lambdaless-custom-resource.OriginalStepFunctionsFlow.Initializer.parameter.scope">scope</a></code> | <code>constructs.Construct</code> | *No description.* |
| <code><a href="#aws-cdk-lambdaless-custom-resource.OriginalStepFunctionsFlow.Initializer.parameter.id">id</a></code> | <code>string</code> | Descriptive identifier for this chainable. |
| <code><a href="#aws-cdk-lambdaless-custom-resource.OriginalStepFunctionsFlow.Initializer.parameter.props">props</a></code> | <code><a href="#aws-cdk-lambdaless-custom-resource.OriginalStepFunctionsFlowProps">OriginalStepFunctionsFlowProps</a></code> | *No description.* |

---

##### `scope`<sup>Required</sup> <a name="scope" id="aws-cdk-lambdaless-custom-resource.OriginalStepFunctionsFlow.Initializer.parameter.scope"></a>

- *Type:* constructs.Construct

---

##### `id`<sup>Required</sup> <a name="id" id="aws-cdk-lambdaless-custom-resource.OriginalStepFunctionsFlow.Initializer.parameter.id"></a>
...
##### `props`<sup>Required</sup> <a name="props" id="aws-cdk-lambdaless-custom-resource.OriginalStepFunctionsFlow.Initializer.parameter.props"></a>

- *Type:* <a href="#aws-cdk-lambdaless-custom-resource.OriginalStepFunctionsFlowProps">OriginalStepFunctionsFlowProps</a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#aws-cdk-lambdaless-custom-resource.OriginalStepFunctionsFlow.toString">toString</a></code> | Returns a string representation of this construct. |
| <code><a href="#aws-cdk-lambdaless-custom-resource.OriginalStepFunctionsFlow.with">with</a></code> | Applies one or more mixins to this construct. |
| <code><a href="#aws-cdk-lambdaless-custom-resource.OriginalStepFunctionsFlow.next">next</a></code> | Continue normal execution with the given state. |
| <code><a href="#aws-cdk-lambdaless-custom-resource.OriginalStepFunctionsFlow.prefixStates">prefixStates</a></code> | Prefix the IDs of all states in this state machine fragment. |
| <code><a href="#aws-cdk-lambdaless-custom-resource.OriginalStepFunctionsFlow.toSingleState">toSingleState</a></code> | Wrap all states in this state machine fragment up into a single state. |

---

##### `toString` <a name="toString" id="aws-cdk-lambdaless-custom-resource.OriginalStepFunctionsFlow.toString"></a>
...
##### `with` <a name="with" id="aws-cdk-lambdaless-custom-resource.OriginalStepFunctionsFlow.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="aws-cdk-lambdaless-custom-resource.OriginalStepFunctionsFlow.with.parameter.mixins"></a>
...
##### `next` <a name="next" id="aws-cdk-lambdaless-custom-resource.OriginalStepFunctionsFlow.next"></a>
...
###### `next`<sup>Required</sup> <a name="next" id="aws-cdk-lambdaless-custom-resource.OriginalStepFunctionsFlow.next.parameter.next"></a>

- *Type:* aws-cdk-lib.aws_stepfunctions.IChainable

---

##### `prefixStates` <a name="prefixStates" id="aws-cdk-lambdaless-custom-resource.OriginalStepFunctionsFlow.prefixStates"></a>
...
###### `prefix`<sup>Optional</sup> <a name="prefix" id="aws-cdk-lambdaless-custom-resource.OriginalStepFunctionsFlow.prefixStates.parameter.prefix"></a>
...
##### `toSingleState` <a name="toSingleState" id="aws-cdk-lambdaless-custom-resource.OriginalStepFunctionsFlow.toSingleState"></a>
...
###### `options`<sup>Optional</sup> <a name="options" id="aws-cdk-lambdaless-custom-resource.OriginalStepFunctionsFlow.toSingleState.parameter.options"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#aws-cdk-lambdaless-custom-resource.OriginalStepFunctionsFlow.isConstruct">isConstruct</a></code> | Checks if `x` is a construct. |

---

##### `isConstruct` <a name="isConstruct" id="aws-cdk-lambdaless-custom-resource.OriginalStepFunctionsFlow.isConstruct"></a>

```typescript
import { OriginalStepFunctionsFlow } from 'aws-cdk-lambdaless-custom-resource'

OriginalStepFunctionsFlow.isConstruct(x: any)
```
...
###### `x`<sup>Required</sup> <a name="x" id="aws-cdk-lambdaless-custom-resource.OriginalStepFunctionsFlow.isConstruct.parameter.x"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#aws-cdk-lambdaless-custom-resource.OriginalStepFunctionsFlow.property.node">node</a></code> | <code>constructs.Node</code> | The tree node. |
| <code><a href="#aws-cdk-lambdaless-custom-resource.OriginalStepFunctionsFlow.property.endStates">endStates</a></code> | <code>aws-cdk-lib.aws_stepfunctions.INextable[]</code> | The states to chain onto if this fragment is used. |
| <code><a href="#aws-cdk-lambdaless-custom-resource.OriginalStepFunctionsFlow.property.id">id</a></code> | <code>string</code> | Descriptive identifier for this chainable. |
| <code><a href="#aws-cdk-lambdaless-custom-resource.OriginalStepFunctionsFlow.property.startState">startState</a></code> | <code>aws-cdk-lib.aws_stepfunctions.State</code> | The start state of this state machine fragment. |

---

##### `node`<sup>Required</sup> <a name="node" id="aws-cdk-lambdaless-custom-resource.OriginalStepFunctionsFlow.property.node"></a>
...
##### `endStates`<sup>Required</sup> <a name="endStates" id="aws-cdk-lambdaless-custom-resource.OriginalStepFunctionsFlow.property.endStates"></a>
...
##### `id`<sup>Required</sup> <a name="id" id="aws-cdk-lambdaless-custom-resource.OriginalStepFunctionsFlow.property.id"></a>
...
##### `startState`<sup>Required</sup> <a name="startState" id="aws-cdk-lambdaless-custom-resource.OriginalStepFunctionsFlow.property.startState"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#aws-cdk-lambdaless-custom-resource.LambdalessCustomResourceProps.property.workflow">workflow</a></code> | <code>aws-cdk-lib.aws_stepfunctions.IStateMachine</code> | *No description.* |
...
##### `workflow`<sup>Required</sup> <a name="workflow" id="aws-cdk-lambdaless-custom-resource.LambdalessCustomResourceProps.property.workflow"></a>

```typescript
public readonly workflow: IStateMachine;
```
...
### LambdalessProviderProps <a name="LambdalessProviderProps" id="aws-cdk-lambdaless-custom-resource.LambdalessProviderProps"></a>

#### Initializer <a name="Initializer" id="aws-cdk-lambdaless-custom-resource.LambdalessProviderProps.Initializer"></a>

```typescript
import { LambdalessProviderProps } from 'aws-cdk-lambdaless-custom-resource'

const lambdalessProviderProps: LambdalessProviderProps = { ... }
```


### OriginalStepFunctionsFlowProps <a name="OriginalStepFunctionsFlowProps" id="aws-cdk-lambdaless-custom-resource.OriginalStepFunctionsFlowProps"></a>

#### Initializer <a name="Initializer" id="aws-cdk-lambdaless-custom-resource.OriginalStepFunctionsFlowProps.Initializer"></a>

```typescript
import { OriginalStepFunctionsFlowProps } from 'aws-cdk-lambdaless-custom-resource'

const originalStepFunctionsFlowProps: OriginalStepFunctionsFlowProps = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#aws-cdk-lambdaless-custom-resource.OriginalStepFunctionsFlowProps.property.stateMachine">stateMachine</a></code> | <code>aws-cdk-lib.aws_stepfunctions.IStateMachine</code> | *No description.* |

---

##### `stateMachine`<sup>Required</sup> <a name="stateMachine" id="aws-cdk-lambdaless-custom-resource.OriginalStepFunctionsFlowProps.property.stateMachine"></a>
